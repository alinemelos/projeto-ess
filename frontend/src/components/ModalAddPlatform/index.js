        ...
        <div style={styles.content}>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            <label style={styles.label}>
              Nome:
              <input type='text' value={nome} onChange={(e) => setNome(e.target.value)} style={styles.input} required />
            </label>
            <label style={styles.label}>
              URL:
              <input type='url' value={url} onChange={(e) => setUrl(e.target.value)} style={styles.input} required />
            </label>
            <label style={styles.label}>
              URL da Imagem:
              <input type='url' value={imageUrl} onChange={(e) => setImageUrl(e.target.value)} style={styles.input} required />
            </label>
